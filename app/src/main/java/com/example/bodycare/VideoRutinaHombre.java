...
public class VideoRutinaHombre extends AppCompatActivity {
    VideoView videoview;
    TextView titulo, descripcion;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_video_rutina_hombre);
    ...
    private void mostrarVideo(){
        ...
        if(nombre.equals("Rutina 1")){
            videoview.setVideoURI(Uri.parse("android.resource://"+ getPackageName() + "/" + R.raw.rh1));
        }else if (nombre.equals("Rutina 2")){
            videoview.setVideoURI(Uri.parse("android.resource://"+ getPackageName() + "/" + R.raw.rh2));
        }else if (nombre.equals("Rutina 3")){
            videoview.setVideoURI(Uri.parse("android.resource://"+ getPackageName() + "/" + R.raw.rh3));
        }else if (nombre.equals("Rutina 4")){
            videoview.setVideoURI(Uri.parse("android.resource://"+ getPackageName() + "/" + R.raw.rh4));
        }
